...
public final class Constants {
	...
	/**
	 * JSON-only field representing the target id specified in field to.
	 */
	public static final String JSON_TO = "to";

	/**
	 * JSON-only field representing the priority of the message.
	 */
	public static final String JSON_PRIORITY = "priority";

	/**
	 * JSON-only field representing the flag content available of the message.
	 */
	public static final String JSON_CONTENT_AVAILABLE = "content_available";

	/**
	 * JSON-only field representing the flag content available of the message.
	 */
	public static final String JSON_DELIVERY_RECEIPT_REQUESTED = "delivery_receipt_requested";

	/**
	 * JSON-only field representing the payload data.
	 */
	public static final String JSON_PAYLOAD_DATA = "data";
	/**
